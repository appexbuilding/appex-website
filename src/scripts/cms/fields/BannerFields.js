export default [
  ...
  {
    label: "Banner Background Video", name: "banner_video", widget: "string", required: false,
  },
  {
  ...
  {
    label: "Banner Full Height", name: "banner_full_height", widget: "boolean", required: false,
  },
];
